...
const validateProfileData = (req) => {
    const allowedEditProdileData = ["firstName", "lastName", "age", "gender", "photoUrl", "about", "skills"];

    const isValid = Object.keys(req.body).every((key) => allowedEditProdileData.includes(key));
